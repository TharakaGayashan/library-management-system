<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="libraryM.adminbookinventory" %>
         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row mt-4">
                     <div class="col-4 ">
                        <asp:Button ID="Button1" class="btn btn-block btn-success w-100" runat="server" Text="Add" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn  btn-block btn-warning w-100" runat="server" Text="Update" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn  btn-block btn-danger w-100" runat="server" Text="Delete" />
                     </div>
                  </div>
               </div>
            </div>
